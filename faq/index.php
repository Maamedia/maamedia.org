...
<div class="topnav">
  <a href="#home" class="active"><img src="https://commons.maamedia.org/images/1/1a/Maamedia_Logo.png" style="width:50px; height:auto;">FAQ</a>
...
<h1 class="masthead-heading text-uppercase mb-0">
					Frequently Asked Questions for Maamedia			</h1>
<h2 style="color:green">You may want to know something about us</h2>
<div id="accordion">
  <div class="card">
    <div class="card-header" id="headingOne">
      <h5 class="mb-0">
        <button class="btn btn-link" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
          What is purpose of Maamedia?
        </button>
      </h5>
    </div>
    ...
    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
      <div class="card-body">
          <div class="reply">
        The purpose of Maamedia is to help people learn things the right way (Masymanwiki, one of Maamedia’s wikis) and to help people and businesses with everyday things to make their lives run smoothly. Maamedia Tools has produced useful tools for everyone to use and, for example, Mawonder is a state-of-the-art social network for Android phones as well.
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="card-header" id="headingTwo">
      <h5 class="mb-0">
        <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
          Who maintains and manages Maamedia?
        </button>
      </h5>
    </div>
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
      <div class="card-body">
        Maamedia founders Mito and Puma have been the main caretakers since the founding of Maamedia. They take care of all the tasks and things until they get a complete team of volunteers and the founders can take more time off and do their own things. Maamedia’s maintenance is divided into several subcategories, and currently the founders have to manage all of these subcategories. Maamedia Government is the administrative team still under discussion, which decides on Maamedia matters, services and scope.
      </div>
    </div>
  </div>
  <div class="card">
    <div class="card-header" id="headingThree">
      <h5 class="mb-0">
        <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
          When Maamedia was founded?
        </button>
      </h5>
    </div>
    <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
      <div class="card-body">
        Maamedia was founded in late January of the year
2021. At the time, its purpose was to help Wikipedia editors, but later the purpose really changed completely and Maamedia began to focus on helping non-Wikipedia. Founded in early February 2021, Masymanwiki (a multilingual guidebook) became Maamedia's main project and Maamedia invests the most in it.
      </div>
    </div>
  </div>
 </div>
